...
import MyDomainsPage from '../../ui/pages/MyDomainsPage.jsx';
...
import ManageDomainsPage from '../../ui/pages/ManageDomainsPage';
...
export const renderRoutes = () => (
  <Router history={browserHistory} >
    <Route path='/' component={App}>
      ...
      <Route path="mydomains" component={MyDomainsPage}/>
      ...
      <Route path="manage/domains" roles={['manage-domains']} group={'super-admin'} component={ManageDomainsPage}/>
